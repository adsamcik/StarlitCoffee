...
sealed interface CoffeeProcessType {
    ...
    enum class Known(
        ...
        WASHED("Washed"),
        NATURAL("Natural", listOf("sun-dried", "sun dried", "sundried")),
        HONEY("Honey", listOf("honey process", "miel")),
        ANAEROBIC("Anaerobic", listOf("anaerobic fermentation")),
        CARBONIC_MACERATION("Carbonic Maceration"),
        SEMI_WASHED("Semi-Washed", listOf("semi washed")),
        WET_HULLED("Wet-Hulled", listOf("wet hulled", "giling basah")),
