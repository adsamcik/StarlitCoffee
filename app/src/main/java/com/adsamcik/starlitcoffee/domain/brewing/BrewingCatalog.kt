...
object BuiltinBrewingCatalog {
    val instance: BrewingCatalog = BrewingCatalog(
        ...
        filterProfiles = listOf(
            ...
            FilterProfile(
                id = FilterProfileId("chemex_six_cup_bonded_paper"),
                medium = FilterMedium.PAPER,
                geometry = FilterGeometry.BREWER_SPECIFIC,
                size = "six_cup",
                disposable = true,
        ...
        brewerProfiles = listOf(
            ...
            profile(
                ...
                "AeroPress",
                OutputModel.BrewWaterMinusRetention(2.0),
                setOf("aeropress_paper", "aeropress_metal"),
                accessories = setOf("aeropress_flow_control_cap"),
                safety = setOf(SafetyTag.HOT_LIQUID, SafetyTag.UNSTABLE_ORIENTATION),
            ),
            profile(
                "aeropress_xl",
                "chamber_plunger",
            ...
            profile(
                "espresso_pump_generic",
                "espresso",
                "Generic pump espresso",
                OutputModel.DirectTargetBeverageYield,
                setOf("espresso_paper_disc"),
                baskets = setOf("espresso_generic_single", "espresso_generic_double"),
                safety = setOf(SafetyTag.HOT_LIQUID, SafetyTag.PRESSURE),
            ),
            profile(
                "espresso_lever_generic",
                "espresso",
                "Generic lever espresso",
                OutputModel.DirectTargetBeverageYield,
                setOf("espresso_paper_disc"),
                baskets = setOf("espresso_generic_single", "espresso_generic_double"),
                safety = setOf(SafetyTag.HOT_LIQUID, SafetyTag.PRESSURE),
            ...
            profile(
                "espresso_portable_generic",
                "espresso",
                "Generic portable espresso",
                OutputModel.DirectTargetBeverageYield,
                setOf("espresso_paper_disc"),
                safety = setOf(SafetyTag.HOT_LIQUID, SafetyTag.PRESSURE),
            ),
            profile(
                "moka_generic_unspecified",
                "steam_pressure_multichamber",
                "Moka pot",
                OutputModel.ReservoirToEstimatedOutput(),
                safety = setOf(SafetyTag.HOT_LIQUID, SafetyTag.HOT_METAL, SafetyTag.PRESSURE),
            ),
            profile(
                "cold_immersion_generic",
                "cold_immersion",
                "Cold-brew vessel",
                OutputModel.CollectedConcentrate(2.0),
                setOf("cold_brew_filter_bag"),
                safety = setOf(SafetyTag.FOOD_STORAGE),
            ),
            profile(
                "clever_style",
                "steep_and_release",
            ...
            profile(
                ...
                allowsUnfiltered = true,
                safety = setOf(SafetyTag.HOT_LIQUID, SafetyTag.HOT_METAL, SafetyTag.OPEN_FLAME),
            ),
            profile(
            ...
            profile(
                ...
                "Vietnamese phin",
                OutputModel.CollectedConcentrate(0.0),
                setOf("phin_metal"),
                accessories = setOf("phin_screw_insert"),
